...
const Banner = () => {
  ...
  return (
    <div className='flex bg-primary rounder-lg px-6 md:px-14 sm:px-10  lg:px-12 my-20 md-mx-10'>
        {/* left side  */}
    ...
    <div className='hidden md:block md:w-1/2 lg:w-[370px] relative' >
         <img className='w-full bottom-0 absolute right-0 max-w-md'  src={assets.appointment_img} alt="" />
    </div>
    </div>
