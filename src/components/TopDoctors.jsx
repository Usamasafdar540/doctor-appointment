...
const TopDoctors = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
      ...
      <button onClick={()=>{navigate('/doctors'); scrollTo (0,0)}} className="mt-6 py-2 px-6 bg-primary text-white rounded-lg hover:bg-blue-600 transition-colors duration-300">
        More
      </button>
    </div>
  );
