  ...
  const navigate = useNavigate();
    ...
    <div className='flex items-center justify-between py-4 text-sm mb-5 border-b border-b-gray-400 shadow-md'>
        ...
        <div className='flex items-center gap-4'>
            {
                token ? <div className='flex items-center group relative cursor-pointer'>
            ...
            <button onClick={()=>navigate('/login')} className='bg-primary text-white px-8 py-3 rounded-full font-light hidden md:block'>Change Account</button>
            }
        </div>
    </div>
  )
